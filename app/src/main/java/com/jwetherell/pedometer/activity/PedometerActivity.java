...
public class PedometerActivity extends Activity {
    ...
    private static final Logger logger = Logger.getLogger(PedometerActivity.class.getSimpleName());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (stepServiceIntent == null) {
            ...
            extras.putInt("int", 1);
            stepServiceIntent = new Intent(PedometerActivity.this, StepService.class);
...
//                    MessageUtilities.confirmUser(PedometerActivity.this, "Exit App without stopping pedometer?", yesExitClick, null);
                    unbindStepService();
    ...
    private OnCheckedChangeListener startStopListener = new OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            if (isChecked && !serviceIsRunning) {
                ...
                MessageUtilities.confirmUser(PedometerActivity.this, "Stop the pedometer?", yesStopClick, noStopClick);
            }
        }
    };
